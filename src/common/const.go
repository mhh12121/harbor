...
const (
	...
	PostGreSQLHOST                   = "127.0.0.1"  //= "postgresql_host"
	PostGreSQLPort                   = "5432"       //= "postgresql_port"
	PostGreSQLUsername               = "postgresql" //= "postgresql_username"
	PostGreSQLPassword               = "root123"    //= "postgresql_password"
